          ...
          <div className="w-full lg:w-[70%] h-full bg-gray-100 p-10 mx-auto">
            ...
            <form className="my-5">
              ...
              <div className="flex flex-col md:flex-row text-center md:items-center justify-between my-10 gap-7">
                <button className="px-9 py-3 font-semibold bg-[#6494edb5] hover:bg-[#6494ed] text-white transition-all duration-1000">
                  Submit
                </button>
                <a
                  href="#"
                  className="px-9 py-3 font-semibold bg-[#6494ed9f] hover:bg-[#6495ed] text-white  transition-all duration-1000"
                >
