      ...
      <section className="w-[100%] h-[calc(100vh-100px)] bg-home-hero">
        <div className="container mx-auto h-full">
          <div className="h-full flex items-center justify-center gap-10 flex-wrap">
           <h1 className="text-[50px] font-bold text-white text-center" >Welcome to <span className="block text-[70px] ">Elision Advertising</span> </h1>
          </div>
        </div>
      </section>
      
      <section className="w-[100%] h-[100vh] gradient-bg">
        <div className="container mx-auto h-full">
          <div className="h-full flex items-center justify-between gap-10 flex-wrap">
            {heroSectionContent.map((card, idx) => (
              <div
                key={idx}
                className="flex-1 min-h-[500px] p-5 rounded-[20px] shadow-lg bg-gray-200 hover:bg-gray-300"
              >
                <div className="flex h-full">
                  ...
                  <div className="w-[70%] h-full p-5 flex flex-col items-start justify-between gap-5">
                    ...
                    <a
                      className="text-[18px] px-5 py-2 bg-black block mx-auto rounded-full font-bold text-white"
                      href=""
                    >
                      {card.designation}
                    </a>
